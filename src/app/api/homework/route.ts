...
// teacherHasAccessToClass/getTeacherAccessibleClasses use.
async function getTeacherAccessibleClasses(teacherId: string, schoolId: string) {
...
async function teacherHasAccessToClass(teacherId: string, schoolId: string, className: string) {
